...
# ╔═╡ 6ee7607b-50d8-4483-b84c-ad8f401bf929
using SparseArrays

# ╔═╡ d4260fcc-784e-4341-ae84-c7e8ab288c4b
using LaTeXStrings, DifferentialEquations, LinearAlgebra
...
# ╔═╡ cb0e57dc-bb6f-4e6d-8084-d7fa8548ac71
DiffEqOp.CenteredDifference

# ╔═╡ 3fd9492a-d75e-4603-bafc-4e48fd422385
## We are trying to solve the following equation 
## ∇²Uᴴ (x⃗) = -∇ ⋅ F(x⃗)
## We are starting in 2 dimensions
function hemholtz(prob::DiscreteProblem, minval::Int64, maxval::Int64, nsample::Int64) 
...
begin
	...
	x, y, u_h = hemholtz(dprob, -3, 3, nsample)
end
